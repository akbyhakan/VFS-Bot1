...
def upgrade() -> None:
    ...
    op.execute("DROP TRIGGER IF EXISTS update_personal_details_updated_at ON personal_details;")
    op.execute("""
    ...
    op.execute("DROP TRIGGER IF EXISTS update_payment_card_updated_at ON payment_card;")
    op.execute("""
    ...
    op.execute("DROP TRIGGER IF EXISTS update_proxy_endpoints_updated_at ON proxy_endpoints;")
    op.execute("""
