...
class NotificationService:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info(f"NotificationService initialized (Telegram: {self.telegram_enabled}, Email: {self.email_enabled})")
...
"""
    ...
    async def notify_booking_success(self, centre: str, date: str, 
                                    time: str, reference: str) -> None:
        """
