...
class TestCentreFetcherCache:
    ...
    def fetcher(self):
        ...
        return CentreFetcher(
            base_url="https://visa.vfsglobal.com", country="tur", mission="nld", cache_ttl=3600
        )
    ...
    async def test_cache_ttl_configuration(self):
        ...
        custom_fetcher = CentreFetcher(
            base_url="https://visa.vfsglobal.com", country="tur", mission="nld", cache_ttl=7200
        )
        ...
        default_fetcher = CentreFetcher(
            base_url="https://visa.vfsglobal.com", country="tur", mission="nld"
        )
