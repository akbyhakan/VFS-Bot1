...
class TestWebhookSignature:
    def test_generate_and_verify(self):
        ...
        assert verify_webhook_signature(payload.encode(), signature, secret)
    ...
    def test_invalid_signature(self):
        ...
        signature = generate_webhook_signature(payload, secret)
        assert not verify_webhook_signature(payload.encode(), signature, wrong_secret)
    ...
    def test_modified_payload(self):
        ...
        signature = generate_webhook_signature(payload, secret)
        assert not verify_webhook_signature(modified_payload.encode(), signature, secret)
    ...
    def test_invalid_signature_format(self):
        ...
        assert not verify_webhook_signature(payload.encode(), "invalid-format", secret)
    ...
    def test_expired_timestamp(self):
        ...
        time_module.time = lambda: old_time
        ...
        assert not verify_webhook_signature(
            payload.encode(), old_signature, secret, timestamp_tolerance=300  # 5 minutes
        )
...
class TestAuditLogger:
    ...
    async def test_sanitize_sensitive_data(self):
        ...
        data = {"username": "test", "password": "secret123", "api_key": "abc123def456"}
    ...
    async def test_sanitize_nested_data(self):
        ...
        data = {"user": {"username": "test", "password": "secret123"}}
    ...
    async def test_buffer_limit(self):
        ...
        for i in range(10):
            await logger.log(AuditAction.LOGIN_SUCCESS, user_id=i, username=f"user{i}")
