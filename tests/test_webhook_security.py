...
class TestWebhookSecurity:
    ...
    def test_webhook_rejects_missing_signature_in_production(self):
        ...
        with patch.dict(os.environ, {"ENV": "production", "SMS_WEBHOOK_SECRET": "test-secret-32-chars-minimum-here"}):
    ...
    def test_webhook_enforces_signature_in_dev_when_secret_configured(self):
        ...
        with patch.dict(os.environ, {"ENV": "development", "SMS_WEBHOOK_SECRET": "test-secret-32-chars-minimum-here"}):
