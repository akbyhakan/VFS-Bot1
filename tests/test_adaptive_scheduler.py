...
class TestAdaptiveScheduler:
    ...
    def test_get_current_mode_peak(self, mock_datetime):
        ...
        mock_datetime.now.return_value = datetime(2024, 1, 1, 9, 0, tzinfo=ZoneInfo("Europe/Istanbul"))
    ...
    def test_get_current_mode_normal(self, mock_datetime):
        ...
        mock_datetime.now.return_value = datetime(2024, 1, 1, 11, 0, tzinfo=ZoneInfo("Europe/Istanbul"))
    ...
    def test_get_current_mode_low(self, mock_datetime):
        ...
        mock_datetime.now.return_value = datetime(2024, 1, 1, 20, 0, tzinfo=ZoneInfo("Europe/Istanbul"))
    ...
    def test_get_current_mode_sleep(self, mock_datetime):
        ...
        mock_datetime.now.return_value = datetime(2024, 1, 1, 3, 0, tzinfo=ZoneInfo("Europe/Istanbul"))
