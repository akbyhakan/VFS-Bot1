...
async def test_update_personal_details_allows_whitelisted_fields(test_db, unique_encryption_key, caplog):
...
@pytest.mark.asyncio
@pytest.mark.security
async def test_update_personal_details_blocks_disallowed_fields(test_db, unique_encryption_key, caplog):
